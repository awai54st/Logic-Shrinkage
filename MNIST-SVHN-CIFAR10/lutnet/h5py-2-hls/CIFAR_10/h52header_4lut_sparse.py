...
if __name__ == "__main__":
    ...
    bl_c_param = np.array(bl["model_weights"]["binary_conv_6"]["binary_conv_6"]["Variable_1:0"])
    ...
    bl_pruning_mask = np.array(bl["model_weights"]["binary_conv_6"]["binary_conv_6"]["pruning_mask:0"]).reshape(bl_c_param[0].shape)
    bl_gamma = np.array(bl["model_weights"]["binary_conv_6"]["binary_conv_6"]["Variable:0"])
 
    bl_shrinkage_map = np.array(bl["model_weights"]["binary_conv_6"]["binary_conv_6"]["shrinkage_map:0"])
