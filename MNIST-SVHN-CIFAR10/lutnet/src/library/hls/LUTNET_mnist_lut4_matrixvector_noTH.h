...
ap_uint<PopCountWidth*M> Naive4LUTNOTH_MNIST(ap_uint<MACS> in[PRECISION_REB], ap_uint<MACS> in_1[PRECISION_REB], ap_uint<MACS> in_2[PRECISION_REB], ap_uint<MACS> in_3[PRECISION_REB], const ap_fixed<PopCountWidth, PopCountIntWidth> *alpha, bool pt) {
        #pragma HLS latency min=4 max=7
        ap_uint<PopCountWidth*M> tmp_out = 0;
        ...
        #pragma HLS UNROLL
            ...
            tmp_out.range(PopCountWidth*(tm+1)-1,PopCountWidth*tm) = accReg[tm];
...
//            if (tc==outCol-1) pt = 1;
//            else pt = 0;
            tmp_out = Naive4LUTNOTH_MNIST<PRECISION_REB, N*K*K, PopCountWidth, PopCountIntWidth, M, LAYERID> (tmp_in_reb, tmp_in_1_reb, tmp_in_2_reb, tmp_in_3_reb, alpha, pt);
