...
if __name__ == "__main__":
    ...
    print("targetDirHLS", targetDirHLS)
    ...
    weights_per_act = 1 # weights_per_act = #_of_bits_per_act x 2 ^ #_of_lut_inputs
    ...
    with open(targetDirHLS+'/XNORARRAY_b0_' + str(layer_id) + '.v', 'a') as v0:
        ...
        for tm in range(nfilters):
            ...
            v0.write('assign ap_return_' + str(tm) + ' = ~(ap_const_lv' + str(word_length) + '_0_' + str(tm) + ' ^ lut_out_63_V_write);\n')
        v0.write('endmodule')
    with open(targetDirHLS+'/XNORARRAY_b1_' + str(layer_id) + '.v', 'a') as v1:
        ...
        for tm in range(nfilters):
            ...
            v1.write('assign ap_return_' + str(tm) + ' = ~(ap_const_lv' + str(word_length) + '_0_' + str(tm) + ' ^ lut_out_63_V_write);\n')
        v1.write('endmodule')
