...
K=4
mode='lutnet_logic_shrinkage'
pruning_percentage="0.95" # node sparsity θ
activation_percentage="0.50" # LUT input sparsity i.e. δ in paper, 𝛿 = 0 is the LUTNet design and 𝛿 > 0 is the Logic-Shrinkage design
