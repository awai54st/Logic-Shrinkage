...
def lutnet_logic_shrinkage(dataset, K, get_model, pruning_percentage, activation_pruning_percentage, output_path, custom_rand_seed, training_phase):
	...
	if training_phase == 1:
		...
		logger.info("Started logic expansion (training phase 2/2 part 3/3)\n ")		
		retraining = True
		...
		train_lutnet(dataset, get_model, pruning_percentage, K, Train, REG, Retrain, LUT, BINARY, LOGIC_SHRINKAGE, trainable_means, Evaluate, lutnetFP32Epochs, lutnetBatchSize, output_path, custom_rand_seed)
		logger.info("Finished logic expansion (training phase 2/2 part 3/3)\n ")
